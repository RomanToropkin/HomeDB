    ...
    public partial class HouseholdFilters : Form
    {
        ...
        public HouseholdFilters()
        {
            ...
            _sortList = new List<FilterInfo>
            {
                ...
                new FilterInfo(sortByHouseholdCount, SortType.BY_COUNT, sortCount),
                new FilterInfo(sortByCost, SortType.BY_COST, sortCash),
                new FilterInfo(sortByFinalCost, SortType.BY_FINAL_COST, sortFinalCost),
        ...
        {
            var type = SearchType.SERVICE_NAME;
            if (rbCount.Checked)
            {
            ...
            if (rbCash.Checked)
            {
                type = SearchType.COST;
            }
            if (rbFinalCash.Checked)
            {
        ...
        private void btnGroup_Click(object sender, EventArgs e)
        {
            ...
            if (rbGroupCash.Checked)
            {
                type = GroupType.COST;
            }
            if (rbGroupFinalCash.Checked)
            {
